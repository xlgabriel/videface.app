...
import { brainwaveServices, brainwaveServicesIconClasses } from "../../../../constants";
import {
    PhotoChatMessage,
    Gradient,
    VideoChatMessage,
                        ...
                        <div className="p-4 z-1 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem] shadow-blue-500 shadow-lg">
                            <div className="py-12 px-4 xl:px-8">
                                ...
                                <ul
                                    ...
                                    data-svc-anim
                                >
                                    {brainwaveServicesIconClasses.map((cls, index) => {
                                        return (
                                            <li
                                                key={index}
                                            ...
                                            >
                                                ...
                                                >
                                                    <span className={`iconBase ${cls} w-7 h-7 md:w-7 md:h-7`} aria-hidden />
                                                </div>
                                            </li>
                                        );
                                    })}
