...
import { products, requiredProducts, booths } from "../../constants/products";
...
export default function ProductsList() {
    return (
        <Section className="overflow-hidden" id="productsList">
            ...
            <div className="container relative z-2 mt-32">
                <Heading tag="For a better service" title={<strong>Our booths</strong>} />
            </div>
            <div className="container relative z-2">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 m-4">
                    {booths.map((item) => (
                        <Card key={item.id} product={item} />
                    ))}
                </div>
