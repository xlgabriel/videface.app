            ...
            <table className="w-full table-auto">
                ...
                <tbody>
                    <tr className="border-b">
                        <td className="w-3/5 p-4 text-left font-medium text-n-1 text-sm">
                            VideFace Calls
                        </td>
                        <td className="w-2/5 p-4">
                            {renderValue(rowData.call)}
                        </td>
                    </tr>
                    <tr className="border-b">
                        <td className="w-3/5 p-4 text-left font-medium text-n-1 text-sm">
