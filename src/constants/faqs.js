// Centralized FAQ items for reuse across pages
...
export const keydropFaqItems = [
    {
        id: 1,
        title: 'What is a key drop system?',
        description:
            'A key drop system allows customers to securely return vehicle keys after hours using a monitored and controlled secure key box.',
    },
    {
        id: 2,
        title: 'How does secure key management work?',
        description:
            'Secure key management tracks, records, and stores every key transaction to reduce risk, prevent loss, and improve accountability.',
    },
    {
        id: 3,
        title: 'Is the VideFace key drop secure?',
        description:
            'Yes. Our key drop solution records each interaction, verifies users, and stores all data securely in the cloud.',
    },
    {
        id: 4,
        title: 'Can a key drop system reduce chargebacks?',
        description:
            'Yes. By recording key returns and confirmations, the system helps prevent disputes and protects your business from fraud.',
    },
];
